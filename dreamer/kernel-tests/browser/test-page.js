...
// Import from main dreamer repo (relative path from kernel-tests/browser/)
// When served from dreamer/, paths are relative to that root
import { initDevice, getKernelCapabilities, getDeviceLimits, destroyDevice } from '../../reploid/core/dreamer/gpu/device.js';

// Import kernel functions - some may not exist, so we import what's available
import * as kernelSelector from '../../reploid/core/dreamer/gpu/kernel-selector.js';
...
let bufferPool = null;
try {
  bufferPool = await import('../../reploid/core/dreamer/gpu/buffer-pool.js');
} catch (e) {

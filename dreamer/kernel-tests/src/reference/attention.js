 ...
 *
 * @param {Float32Array} Q - Queries [seqLen, numHeads, headDim]
 * @param {Float32Array} K - Keys [kvLen, numKVHeads, headDim]
 * @param {Float32Array} V - Values [kvLen, numKVHeads, headDim]
 * @param {number} seqLen - Query sequence length
 * @param {number} kvLen - Key/Value sequence length
 * @param {number} numHeads - Number of query heads
 * @param {number} numKVHeads - Number of KV heads (for GQA)
 * @param {number} headDim - Dimension per head
 * @param {Float32Array} mask - Optional attention mask [seqLen, kvLen]
 * @returns {Float32Array} Output [seqLen, numHeads, headDim]
 */

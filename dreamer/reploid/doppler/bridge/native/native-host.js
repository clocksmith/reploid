#!/usr/bin/env node
/**
 * DOPPLER Native Bridge Host (Node.js)
...
// Allowed directories (configurable via DOPPLER_ALLOWED_DIRS env, colon-separated)
    ...
    while ((chunk = process.stdin.read()) !== null) {
      ...
      while (buffer.length >= 4) {
        ...
        try {
          ...
          console.error('[DopplerBridge] Error handling message:', err.message);
        }
      }
    }
  });

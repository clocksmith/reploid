...
function extractModelConfig(metadata, architecture) {
  ...
  // Tokenizer info - extract full vocab data for bundling
  config.tokenizer = {
    model: metadata['tokenizer.ggml.model'],
    // Vocab data for bundling (eliminates transformers.js dependency)
    tokens: metadata['tokenizer.ggml.tokens'],           // string[] - vocab tokens
    scores: metadata['tokenizer.ggml.scores'],           // float[] - unigram scores (optional)
    tokenTypes: metadata['tokenizer.ggml.token_type'],   // int[] - token type flags (optional)
    merges: metadata['tokenizer.ggml.merges'],           // string[] - BPE merges (optional)
    // Special token IDs
    ...
    unkTokenId: metadata['tokenizer.ggml.unknown_token_id'],
    sepTokenId: metadata['tokenizer.ggml.seperator_token_id'],
    clsTokenId: metadata['tokenizer.ggml.cls_token_id'],
    maskTokenId: metadata['tokenizer.ggml.mask_token_id'],
    // Behavior flags
    addBosToken: metadata['tokenizer.ggml.add_bos_token'],
    addEosToken: metadata['tokenizer.ggml.add_eos_token'],
    addSpacePrefix: metadata['tokenizer.ggml.add_space_prefix'],
  };

...
export async function runMoEGather(hiddenStates, expertIndices, numTokens, hiddenSize, numExperts, topK, options = {}) {
  ...
  // Create EXPLICIT bind group layout - required because count_and_map and gather_tokens
  // use different subsets of bindings, and WebGPU 'auto' layout only includes used bindings.
  // See docs/MOE-EXPLICIT-LAYOUT-POSTMORTEM.md for details.
  ...
  // Create pipelines with explicit layout

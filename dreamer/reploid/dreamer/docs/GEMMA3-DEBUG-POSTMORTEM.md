...
**Status**: Already fixed in `loader/dreamer-loader.js`. The loader applies +1 offset to norm weights during loading via `tryLoadNorm()`.
...
- `loader/dreamer-loader.js`: Weight loading with Gemma 3 norm offset

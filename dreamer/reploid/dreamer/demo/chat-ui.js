 ...
 * @property {number} timeMs - Generation time in milliseconds
 * @property {number} tokensPerSec - Tokens per second
 */
...
export class ChatUI {
   ...
   * @param {Function} callbacks.onSend - Called when user sends a message
   * @param {Function} callbacks.onStop - Called when stop is clicked
   ...
   * @param {MessageStats} [stats] - Optional generation stats
   */

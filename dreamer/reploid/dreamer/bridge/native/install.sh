...
{
  "name": "$HOST_NAME",
  "description": "Dreamer Native Bridge - File access for LLM inference",
  "path": "$SCRIPT_DIR/dreamer-bridge.sh",
  "type": "stdio",
  "allowed_origins": [
...
echo "2. Open Dreamer boot screen"
echo "3. Select 'Dreamer' provider"

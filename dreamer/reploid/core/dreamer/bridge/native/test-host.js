#!/usr/bin/env node
/**
 * Test script for Dreamer Native Host
...
async function runTests() {
  console.log('=== Dreamer Native Host Test ===\n');
  ...
  try {
    ...
    const testContent = 'Hello from Dreamer Native Bridge test!';
    ...
    const badReadMsg = createReadMessage(3, '/tmp/nonexistent-dreamer-test-file.txt', 0, 100);

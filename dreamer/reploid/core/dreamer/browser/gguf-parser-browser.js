/**
 * gguf-parser-browser.js - Browser-safe GGUF Parser
 *
 ...
 *
 * @param {ArrayBuffer} buffer - GGUF file contents (can be partial for header-only)
 ...
 *
 * @param {ArrayBuffer} headerBuffer - First chunk of GGUF file (1-10MB)
 * @returns {Object} Parsed model info
 */
export function parseGGUFHeader(headerBuffer) {
...
export { GGMLTypeName, GGML_BLOCK_SIZE, GGML_TYPE_SIZE };

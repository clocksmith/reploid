...
export const SELF_SOURCE_MIRRORS = Object.freeze([
  { webPath: '/src/self/boot-spec.js', vfsPath: '/self/boot-spec.js' },
  ...
  { webPath: '/src/self/instance.js', vfsPath: '/self/instance.js' },
  ...
  { webPath: '/src/self/capsule/index.js', vfsPath: '/self/capsule/index.js' },
  { webPath: '/src/self/host/start-app.js', vfsPath: '/self/host/start-app.js' },
  { webPath: '/src/self/host/seed-vfs.js', vfsPath: '/self/host/seed-vfs.js' },
  { webPath: '/src/self/host/vfs-bootstrap.js', vfsPath: '/self/host/vfs-bootstrap.js' },
  { webPath: '/src/self/host/sw-module-loader.js', vfsPath: '/self/host/sw-module-loader.js' },
  { webPath: '/src/self/kernel/index.html', vfsPath: '/self/kernel/index.html' },
  { webPath: '/src/self/kernel/boot.js', vfsPath: '/self/kernel/boot.js' },
  { webPath: '/src/self/image/manifest.js', vfsPath: '/self/image/manifest.js' },
  { webPath: '/src/self/image/export.js', vfsPath: '/self/image/export.js' }
]);

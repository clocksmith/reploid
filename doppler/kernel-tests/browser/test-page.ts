...
import { initDevice, getKernelCapabilities, getDeviceLimits, destroyDevice } from '../../reploid/doppler/gpu/device.js';

// Import kernel functions - some may not exist, so we import what's available
import * as kernelSelector from '../../reploid/doppler/gpu/kernel-selector.js';
...
try {
  bufferPool = await import('../../reploid/doppler/gpu/buffer-pool.js');
} catch (e) {

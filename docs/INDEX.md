...
- **[docs/poolday/complete-pack-jobs.md](./poolday/complete-pack-jobs.md)** - Explicit public operation delegation, bounded recovery, signed streams and archived acceptance

...
| Conversation Workspace | [`packages/reploid/src/chat/CATSCAN.md`](../packages/reploid/src/chat/CATSCAN.md) | Reploid Browser Library | Concurrent conversations supplied by an authorized peer mesh, without a global objective. |

...
| Poolday Evidence Runtime | [`self/pool/CATSCAN.md`](../self/pool/CATSCAN.md) | Browser Runtime | Compose Reploid's intelligence network via Poolday: authorized storage, compute, evaluated coordination; adjudicate public-protein evidence. |

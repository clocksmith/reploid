...
| Agent Core | [`self/core/CATSCAN.md`](../self/core/CATSCAN.md) | Browser Runtime | Execute bounded agent cycles and tool calls against explicit state, policy, verification, and resource contracts. |
...
| Poolday Evidence Runtime | [`self/pool/CATSCAN.md`](../self/pool/CATSCAN.md) | Browser Runtime | Produce and govern exact, inspectable model and review evidence for bounded public-protein adjudication questions. |
...
| Research Room Interface | [`self/ui/pool-home/CATSCAN.md`](../self/ui/pool-home/CATSCAN.md) | Browser Interfaces | Give curators one room in which to adjudicate a bounded public-protein annotation dispute and choose a justified next action. |

...
| Poolday Evidence Runtime | [`self/pool/CATSCAN.md`](../self/pool/CATSCAN.md) | Browser Runtime | Test model distribution, whole-job execution, and reviewed coordination separately; optional public-protein adjudication. |
...
| Poolday Interface | [`self/ui/pool-home/CATSCAN.md`](../self/ui/pool-home/CATSCAN.md) | Browser Interfaces | Run signed Doppler Packs on peers, share compute, and inspect or recover jobs. |

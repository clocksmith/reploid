...
| Poolday Product Contracts | [`docs/poolday/CATSCAN.md`](poolday/CATSCAN.md) | Documentation | Apply Reploid's goal-first mission to optional peer execution, evidence boundaries, and scientific non-claims. |
...
| Reploid Product Interface | [`self/ui/pool-home/CATSCAN.md`](../self/ui/pool-home/CATSCAN.md) | Browser Interfaces | Pursue goals with helpers, share compute, and review tested tool changes. |

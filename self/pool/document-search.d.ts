...
export interface DocumentSearchResult {
  ...
  answer: { text: string; citations: readonly { number: number; chunkId: string; documentId: string; start: number; end: number }[] } | null;
...
export interface DocumentSearchState {
  ...
  history: readonly { status: 'completed' | 'failed' | 'cancelled'; startedAt: string; result?: DocumentSearchResult; error?: string; receipts?: readonly JsonObject[] }[];
}

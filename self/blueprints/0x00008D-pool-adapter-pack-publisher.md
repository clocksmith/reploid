# Blueprint 0x00008D: pool adapter pack publisher

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/adapter-pack-publisher.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/adapter-pack-publisher.js`

**Former Blueprint Paths:** `self/blueprints/0x00008D-pool-adapter-pack-publisher.md`

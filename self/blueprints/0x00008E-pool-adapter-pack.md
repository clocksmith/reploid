# Blueprint 0x00008E: pool adapter pack

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/adapter-pack.js`, `/self/pool/artifact-origin.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/adapter-pack.js`

**Former Blueprint Paths:** `self/blueprints/0x00008E-pool-adapter-pack.md`

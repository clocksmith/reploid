# Blueprint 0x00009A: pool artifact origin

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/artifact-origin.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/artifact-origin.js`

**Former Blueprint Paths:** `self/blueprints/0x00009A-pool-artifact-origin.md`

# Blueprint 0x00009E: pool peer ledger

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/peer-ledger.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/peer-ledger.js`

**Former Blueprint Paths:** `self/blueprints/0x00009E-pool-peer-ledger.md`

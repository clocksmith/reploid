# Blueprint 0x0000AB: pool rtc config

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/rtc-config.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/rtc-config.js`

**Former Blueprint Paths:** `self/blueprints/0x0000AB-pool-rtc-config.md`

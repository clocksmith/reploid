# Blueprint 0x000080: core promotion policy

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/core/promotion-policy.js`

**Planned Artifacts:** None

**Owned Source Files:** `core/promotion-policy.js`

**Former Blueprint Paths:** `self/blueprints/0x000080-core-promotion-policy.md`

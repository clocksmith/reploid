# Blueprint 0x00008B: DopplerOptimize Tool

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/tools/DopplerOptimize.js`

**Planned Artifacts:** None

**Owned Source Files:** `tools/DopplerOptimize.js`

**Former Blueprint Paths:** `self/blueprints/0x00008B-tools-doppleroptimize.md`

# Blueprint 0x0000AA: pool retry policy

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/retry-policy.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/retry-policy.js`

**Former Blueprint Paths:** `self/blueprints/0x0000AA-pool-retry-policy.md`

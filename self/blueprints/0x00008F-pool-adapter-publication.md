# Blueprint 0x00008F: pool adapter publication

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/adapter-publication.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/adapter-publication.js`

**Former Blueprint Paths:** `self/blueprints/0x00008F-pool-adapter-publication.md`

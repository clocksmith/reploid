# Blueprint 0x000090: pool adapter publisher client

**Classification:** Canonical Full Specification

**Implementation Status:** Implemented

**Verified Artifacts:** `/self/pool/adapter-publisher-client.js`

**Planned Artifacts:** None

**Owned Source Files:** `pool/adapter-publisher-client.js`

**Former Blueprint Paths:** `self/blueprints/0x000090-pool-adapter-publisher-client.md`

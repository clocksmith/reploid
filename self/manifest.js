...
export const SELF_SOURCE_MIRRORS = Object.freeze([
  ...
  { webPath: '/core/change-passport.js', vfsPath: '/self/core/change-passport.js' },
  { webPath: '/core/change-passport-policy.js', vfsPath: '/self/core/change-passport-policy.js' },
  { webPath: '/core/change-passport-improvement-adapter.js', vfsPath: '/self/core/change-passport-improvement-adapter.js' },
  { webPath: '/core/visual-change-passport.js', vfsPath: '/self/core/visual-change-passport.js' },
  { webPath: '/shared/change-passport/contract.js', vfsPath: '/self/shared/change-passport/contract.js' },
  { webPath: '/shared/change-passport/policy.js', vfsPath: '/self/shared/change-passport/policy.js' },
  { webPath: '/shared/change-passport/improvement-adapter.js', vfsPath: '/self/shared/change-passport/improvement-adapter.js' },
  { webPath: '/shared/change-passport/visual-change.js', vfsPath: '/self/shared/change-passport/visual-change.js' },

...
export declare function downloadDistributedShard(
  baseUrl: string,
  shardIndex: number,
  shardInfo: DistributionShardInfo,
...
export type ShardTransport = (baseUrl: string, shardIndex: number, shardInfo: DistributionShardInfo, options: DownloadShardOptions) => Promise<DownloadShardResult>;

// vision_position_embedding_f16.wgsl
...
@group(0) @binding(1) var<storage, read> table: array<f16>;
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    output[output_idx] = f32(table[x * u.hidden_size + hidden_idx])
        + f32(table[y_table_offset + y * u.hidden_size + hidden_idx]);
}
